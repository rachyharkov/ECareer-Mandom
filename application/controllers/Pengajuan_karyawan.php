...
class Pengajuan_karyawan extends CI_Controller
{
    ...
    public function read($id) 
    {
		...
		'priority_id' => $row->priority_id,
            ...
            $this->load->view('pengajuan_karyawan/pengajuan_karyawan_read', $data);
        } else {
	...
	$this->form_validation->set_rules('sp_keahlian', 'sp keahlian', 'trim|required');
	...
	$this->form_validation->set_rules('dp_sot', 'dp sot', 'trim|required');
	$this->form_validation->set_rules('dp_jdesk', 'dp jdesk', 'trim|required');
	...
	$this->form_validation->set_rules('diajukanoleh', 'diajukanoleh', 'trim|required');
