...
class Fakultas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','fakultas/tbl_fakultas_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'fakultas' => $row->fakultas,
            ...
            $this->template->load('template','fakultas/tbl_fakultas_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','fakultas/tbl_fakultas_form', $data);
    }
