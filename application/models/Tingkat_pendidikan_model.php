...
class Tingkat_pendidikan_model extends CI_Model
{
    ...
    public $id = 'id_tingkat_pendidikan';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('id_tingkat_pendidikan', $q);
...
/* End of file Tingkat_pendidikan_model.php */
/* Location: ./application/models/Tingkat_pendidikan_model.php */
